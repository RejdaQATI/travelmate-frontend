...
<div className="relative container mx-auto py-8">
  ...
  {/* Navigation buttons */}
  <div className="absolute right-0 top-0 flex items-center space-x-2 pr-4 pt-10 z-10 mt-8 hidden md:flex"> {/* Hide on small screens */}
    {/* Prev Button */}
